    ...
    public function registerUtmSourcesPostType() {
        register_post_type( CANONICAL_PAGES_UTM_CPT, array(
            'labels' => array(
                ...
                'menu_name'          => __( 'Canonical UTM Sources', 'canonical-pages' ),
                'add_new_item'       => __( 'Add New Canonical UTM Source', 'canonical-pages' ),
                ...
                'all_items'          => __( 'Canonical UTM Sources', 'canonical-pages' ),
            ),
            'public'              => false,
            'show_ui'             => true,
            'show_in_menu'        => true,
